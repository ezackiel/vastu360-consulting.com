...
const ROOM_LABELS_FALLBACK = {
  entrance: "Entrance", kitchen: "Kitchen", bedroom: "Master Bedroom", room2: "Bedroom", room3: "Bedroom", room4: "Bedroom",
...
const CENTRE_CLASSIFICATION = {
  ...
  room3:        { rating: "caution", severity: "Low",  note: "A bedroom isn't a classical taboo at the centre, but it does mean the core of the home is enclosed rather than open — not ideal, not severe." },
  room4:        { rating: "caution", severity: "Low",  note: "A bedroom isn't a classical taboo at the centre, but it does mean the core of the home is enclosed rather than open — not ideal, not severe." },
