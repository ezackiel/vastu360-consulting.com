...
const ROOM_PROPORTION_GUIDANCE = {
  ...
  room3:        { idealMin: 1.1, idealMax: 1.3, idealLabel: "around 1.1–1.3 : 1 (e.g. roughly 10 x 12 to 12 x 14 ft)" },
  room4:        { idealMin: 1.1, idealMax: 1.3, idealLabel: "around 1.1–1.3 : 1 (e.g. roughly 10 x 12 to 12 x 14 ft)" },
...
function roomLabel(roomId) {
  const labels = {
    entrance: "main entrance", kitchen: "kitchen", bedroom: "bedroom", room2: "bedroom", room3: "bedroom", room4: "bedroom",
