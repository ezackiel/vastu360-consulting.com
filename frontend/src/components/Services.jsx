    ...
    <section className="services" id="services">
      <div className="wrap">
        <div className="section-head">
          ...
          <p>Every package includes a written report. Silver and Gold add a live consultation, plus deeper room coverage and extended support — Gold adds an in-person site visit.</p>
        </div>
